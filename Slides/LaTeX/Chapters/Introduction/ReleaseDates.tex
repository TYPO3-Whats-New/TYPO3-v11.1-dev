...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item
			\begingroup
				\color{typo3orange}
		v11.1 \tabto{1.1cm}23/Fév./2021\tabto{3.4cm}Authentification multi-facteurs
			\endgroup
		\item v11.2 \tabto{1.1cm}04/Mai~/2021\tabto{3.4cm}Liens de partage pour le backend TYPO3
		\item v11.3 \tabto{1.1cm}13/Jui./2021\tabto{3.4cm}(\textit{à déterminer})
		\item v11.4 \tabto{1.1cm}07/Sep./2021\tabto{3.4cm}Gèle des fonctionnalités
